...
<?php
    ...
    include IncludeFileByLanguage('Clients',$_SESSION['Language']);
    include 'Controller/Function/C-F-AlertMessage.php';
    include 'Controller/C-Clients.php';
...
<head>
    ...
    <title> <?php echo $System_Name;?> | Clients </title>
    ...
    <link rel="stylesheet" href="CSS-Files/Style-Clients.css">
    <!-- End The Links Files -->
</head>
...
<body>
    ...
    <?php include ("Layouts/Clients-Body.php"); ?>
    ...
    <script type="text/javascript" src="Javascript-Files/Main-Clients.js"></script>
    <!-- End The Links Files -->
</body>
