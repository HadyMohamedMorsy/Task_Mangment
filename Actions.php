...
<?php
    ...
    include IncludeFileByLanguage('Actions',$_SESSION['Language']);
    include 'Controller/Function/C-F-AlertMessage.php';
    include 'Controller/C-Actions.php';
...
<head>
    ...
    <title> <?php echo $System_Name;?> | Actions </title>
    ...
    <link rel="stylesheet" href="CSS-Files/Style-Actions.css">
...
<body>
    ...
    <?php include ("Layouts/Actions-Body.php"); ?>
    ...
    <script type="text/javascript" src="Javascript-Files/Main-Actions.js"></script>
    <!-- End The Links Files -->
</body>
