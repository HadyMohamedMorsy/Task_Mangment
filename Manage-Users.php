...
<?php
    ...
    include IncludeFileByLanguage('Manage-Users',$_SESSION['Language']);
    include 'Controller/Function/C-F-AlertMessage.php';
    include 'Controller/C-Manage-Users.php';
...
<head>
    ...
    <title> <?php echo $System_Name;?> | Manage Users </title>
    ...
    <link rel="stylesheet" href="CSS-Files/Style-Manage-Users.css">
    <!-- End The Links Files -->
</head>
...
<body>
    ...
    <?php include ("Layouts/Manage-Users-Body.php"); ?>
    ...
    <script type="text/javascript" src="Javascript-Files/Main-Manage-Users.js"></script>
    <!-- End The Links Files -->
</body>
