...
<?php
    ...
    include IncludeFileByLanguage('Events',$_SESSION['Language']);
    include 'Controller/Function/C-F-AlertMessage.php';
    include 'Controller/C-Events.php';
...
<head>
    ...
    <title> <?php echo $System_Name;?> | Events </title>
    <!-- Start The Links Files -->
    <?php include ("Links CSS In Head Area.php"); ?>
    <link rel="stylesheet" href="Ckidtor/css/sample.css">
    <link rel="stylesheet" href="CSS-Files/Style-Events.css">
...
<body>
    ...
    <script type="text/javascript" src="Javascript-Files/Main-Events.js"></script>
    <!-- End The Links Files -->
</body>
