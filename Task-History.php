...
<?php
    ...
    include IncludeFileByLanguage('Task-History',$_SESSION['Language']);
    include 'Controller/Function/C-F-AlertMessage.php';
    include 'Controller/C-Task-History.php';
...
<head>
    ...
    <title> <?php echo $System_Name;?> | Task History </title>
    <!-- Start The Links Files -->
    <?php include ("Links CSS In Head Area.php"); ?>
    <link rel="stylesheet" href="table-style/css/table-css.css">
    <link rel="stylesheet" href="CSS-Files/Style-Task-History.css">
    <!-- End The Links Files -->
</head>
...
<body>
    ...
    <?php include ("Layouts/Task-History-Body.php"); ?>
    ...
    <script type="text/javascript" src="Javascript-Files/Main-Task-History.js"></script>
    <!-- End The Links Files -->
</body>
